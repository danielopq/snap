...
Responsive Frontend development with drop down navigation for a website dedicated to remote work. It is optimized for desktop (1440px) and mobile (375-480px). The elements have been set according to the design images provided. Built with HTML, CSS and JavaScript. No frameworks were used.
...
- Live Site URL: [https://danielmartinez.co.uk/projects/snap]
